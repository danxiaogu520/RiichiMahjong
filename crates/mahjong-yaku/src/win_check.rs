use mahjong_core::tile::{Suit, Tile, TileType};
...
mod tests {
    ...
    fn test_is_win_shape_standard() {
        ...
        assert!(is_win_shape(&tiles));
    }

    #[test]
    fn test_is_win_shape_not_winning() {
        let tiles = vec![
            TileType(0), TileType(0), TileType(0),
            TileType(1), TileType(1), TileType(1),
            TileType(2), TileType(2), TileType(2),
            TileType(3), TileType(3), TileType(3),
            TileType(4), TileType(5),
        ];
        assert!(!is_win_shape(&tiles));
    }

    #[test]
    fn test_decompose_hand_standard() {
        // 112233m 445566p 77s
        let tiles = vec![
            TileType(0), TileType(0), TileType(1), TileType(1), TileType(2), TileType(2),
            TileType(9), TileType(9), TileType(10), TileType(10), TileType(11), TileType(11),
        ...
        let results = decompose_hand(&tiles);
        assert!(!results.is_empty());
    }

    #[test]
    fn test_furiten_blocks_ron() {
